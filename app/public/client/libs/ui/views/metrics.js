    ...
    "Rating":
      (s, e) =>
        [
          ...
          ["Avg. % Get-ahead (>1d)", x => Math.tanh(x * 1.5 / 100) * 0.10],
          ["Work Completed % of Total", x => Math.tanh(x / 100 * 1.5 - 0.1) * 2 * (0.15) / 2],
          ["Time Tracked % Prod. (All)", x => Math.abs(Math.tanh(x / 1.5 / 100) * 2) * 0.08],
