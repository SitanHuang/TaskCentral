    ...
    "Rating":
      (s, e) =>
        [
          ...
          ["Avg. % Get-ahead", x => Math.tanh(x * 1.5) * 0.06],
          ["Avg. % Get-ahead (>1d)", x => Math.tanh(x * 1.5) * 0.09],
          ["Work Completed % of Total", x => Math.tanh(x * 1.5 - 0.1) * 0.10],
          ...
          ["Work Net % of Start (All)", x => 0.15 * Math.tanh(-1.2 * x) * 2],
